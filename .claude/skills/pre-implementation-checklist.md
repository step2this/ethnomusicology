...
- [ ] **Handoff read** — if continuing from a prior session, `docs/session-handoff.md` has been read
- [ ] **Dependencies added** — any new dependencies are in `backend/Cargo.toml` or `frontend/pubspec.yaml` before spawning parallel agents
