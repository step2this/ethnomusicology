...
- [ ] **Q1: Two-pass critic review** — Run 7a (security/arch) and 7b (code quality) critic passes on the full diff. Fix all CRITICAL/HIGH findings. Acceptance: both critics approve.

- [ ] **Q2: Verify UC-020** — Run /verify-uc against UC-020 postconditions. All must pass. Acceptance: verification report shows all postconditions met.

## Post-Milestone

- [ ] **PM1: Retrospective** — Write `docs/retrospectives/phase-7-purchase-links.md`. Capture lessons, update action items. Feed into CLAUDE.md if needed.
- [ ] **PM2: Update progress docs** — Update `docs/mvp-progress.md`, `MEMORY.md`, `docs/mvp-roadmap.md`. Mark Phase 7 complete.
